...
This page contains some useful information related to the course and the lecture notes. 

#### Prerequisites {-}

The course assumes that you are familiar with previous maths courses from your degree. In particular, we will be using concepts from Discrete mathematics, and make extensive use of modular arithmetic. Refreshers for these topics will be uploaded soon.
